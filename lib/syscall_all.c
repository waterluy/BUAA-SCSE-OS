 ...
 */
void *bcopy(void *destaddr, void const *srcaddr, u_int len)
{
	char *dest = destaddr;
...
int sys_write_dev(int sysno, u_int va, u_int dev, u_int len)
{
    ...
    u_int kva = dev + (u_int)0xA0000000;
    if ((dev >= (u_int)0x10000000) && (dev + len <= (u_int)0x10000020)) { // console
        bcopy((void *)va, (void const *)kva, len);
        return 0;
    } else if ((dev >= (u_int)0x13000000) && (dev + len <= (u_int)0x13004200)) {
        bcopy((void *)va, (void const *)kva, len);
        return 0;
    } else if ((dev >= (u_int)0x15000000) && (dev + len <= (u_int)0x15000200)) {
        bcopy((void *)va, (void const *)kva, len);
        return 0;
    } else {
        return -E_INVAL;
...
int sys_read_dev(int sysno, u_int va, u_int dev, u_int len)
{
    ...
    u_int kva = dev + (u_int)0xA0000000;
    if ((dev >= (u_int)0x10000000) && (dev +len <= (u_int)0x10000020)) { // console
        bcopy((void *)kva, (void const *)va, len);
        return 0;
    } else if ((dev >= (u_int)0x13000000) && (dev + len <= (u_int)0x13004200)) {
        bcopy((void *)kva, (void const *)va, len);
        return 0;
