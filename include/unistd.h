...
#define SYS_get_thread_id   ((__SYSCALL_BASE ) + (15 ) )
#define SYS_thread_alloc    ((__SYSCALL_BASE ) + (16 ) )
#define SYS_set_thread_status   ((__SYSCALL_BASE ) + (17 ) )
#define SYS_thread_destroy  ((__SYSCALL_BASE ) + (18 ) )
#define SYS_thread_join     ((__SYSCALL_BASE ) + (19 ) )
#define SYS_sem_init        ((__SYSCALL_BASE ) + (20 ) )
#define SYS_sem_destroy     ((__SYSCALL_BASE ) + (21 ) )
#define SYS_sem_post        ((__SYSCALL_BASE ) + (22 ) )
#define SYS_sem_wait        ((__SYSCALL_BASE ) + (23 ) )
#define SYS_sem_try_wait    ((__SYSCALL_BASE ) + (24 ) )
#define SYS_sem_get_value   ((__SYSCALL_BASE ) + (25 ) )
#endif
